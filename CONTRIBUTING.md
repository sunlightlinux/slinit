...
- **Functional tests**: `./tests/functional/run-tests.sh` (201 QEMU-based tests)
- **Acceptance tests**: `./tests/acceptance/ssh/run.sh` (194 SSH-driven cases against a live VM)
...
- `tests/functional/` - QEMU integration tests (201 cases)
