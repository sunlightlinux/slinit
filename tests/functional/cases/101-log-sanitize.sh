#!/bin/sh
# Test: svlogd -r / -R sanitize. Control bytes in the input are
# rewritten to the sanitize char before landing in the on-disk log.

SVC="test-logsanitize"
LOG_DIR=/tmp/functional-logsanitize
