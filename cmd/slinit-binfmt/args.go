...
// parseArgs is the same getopt_long-lite walker as the other slinit
// standalone binaries. Short: -u/-v/-h/-V. Long: --unregister, --verbose,
// --root=DIR, --help, --version. Everything else is a positional file
// path.
...
func printUsage() {
	fmt.Print(`Usage: slinit-binfmt [OPTIONS] [FILE...]

Without arguments, applies every *.conf under:
  /usr/lib/binfmt.d, /usr/local/lib/binfmt.d, /run/binfmt.d, /etc/binfmt.d
Later directories override earlier ones when file basenames collide.

Options:
  -u, --unregister   tear down every currently-registered format
  -v, --verbose      print a summary line to stderr
      --root DIR     prefix DIR onto every hardcoded path (test seam)
  -h, --help         this help
  -V, --version      version string

Exit: 0 ok  1 partial failure  2 usage  3 binfmt_misc not available
`)
}
